    ...
    const team =[
        {
            name: "Nikhil Kamath",
            role: "Co-founder & CFO",
            img: process.env.PUBLIC_URL + "/Media/images/Nikhil.jpg",
        ...
        },
        {
            ...
            role: "CTO",
            img: process.env.PUBLIC_URL + "/Media/images/Kailash.jpg",
        ...
        },
        {
            name: "Venu Madhav",
            role: "CEO",
            img: process.env.PUBLIC_URL + "/Media/images/Venu.jpg",
        ...
        },
        {
            name: "Seema Patil",
            role: "Director",
            img: process.env.PUBLIC_URL + "/Media/images/Seema.jpg",
        ...
        },
        {
            ...
            img: process.env.PUBLIC_URL + "/Media/images/Karthik.jpg",
        ...
        },
        {
            ...
            img: process.env.PUBLIC_URL + "/Media/images/Austin.jpg",
